...
const NAV = [
  ...
  { to: "/capteurs", label: "Capteurs SDR", icon: "🔭" },
    ...
    <aside className="sidebar text-white flex flex-col">
      <div className="px-5 py-6 border-b border-white/10">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-sm font-bold">P3</div>
          <div>
            <p className="font-bold text-sm">SN-SSR</p>
            <p className="text-white/60 text-[10px]">Surveillance Spectre</p>
          </div>
        </div>
      </div>
