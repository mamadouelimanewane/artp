...
const NAV = [
  ...
  { to: "/api", label: "API Reference", icon: "⚡" },
  { to: "/explorer", label: "Explorateur", icon: "🔍" },
    ...
    <aside className="sidebar text-white flex flex-col">
      <div className="px-5 py-6 border-b border-white/10">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-sm font-bold">P7</div>
          <div>
            <p className="font-bold text-sm">data.artp.sn</p>
            <p className="text-white/60 text-[10px]">Open Data Public</p>
          </div>
        </div>
      </div>
